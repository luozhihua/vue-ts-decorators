...
export { Vue, Component, Mixin, Mixin as Mixins, Props, Prop, Watch, Model, Inject, Provide, Emit, Lifecycle, Lifecycle as LifeCycle, Data, Render, On, Once, Filter, State, Getter, Action, Mutation, namespace };
